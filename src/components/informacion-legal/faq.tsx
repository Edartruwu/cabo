  ...
  const accordion: Accordion[] = [
    {
      ...
      largeContent: [
        ...
        {
          title:
            "10. Envios del Proveedor Compra en USA y Servicio de consolidación",
          content: [
        ...
        {
          title:
            "16. Sobre el In and Out o entrada y salida de paquetes o documentos",
          content: [
        ...
        {
          title:
            "21. Límite de responsabilidad por pérdida, deterioro, destrucción o robo",
          content: [
    ...
    },
    {
      id: "4",
      trigger:
        "Términos y condiciones de uso de canal “Contáctate con nosotros”",
      content: [
          ...
          list: [
            {
              title: "USUARIO:",
              description:
                "Persona que no posee una relación jurídica contractual con TERRAMARE GROUP S.A.C., pero desea obtener información (al detalle) sobre los servicios que esta última presta a traves de su marca CABO Courier.",
            },
            {
            ...
            {
              title:
                "NORMATIVA PERUANA VIGENTE EN MATERIA DE PROTECCIÓN DE DATOS:",
              description:
                " significa, conjuntamente, la Ley 29733, Ley de Protección de Datos Personales, su reglamento, y disposiciones modificatorias; así como cualquier disposición normativa del ordenamiento jurídico peruano que regule la materia de tratamiento de datos personales en la República del Perú.",
            },
          ],
        },
        {
          title:
            "II. CONDICIONES LEGALES PARA LA ACEPTACIÓN DE LOS TÉRMINOS Y CONDICIONES DE USO:",
          content: [
          ...
          list: [
            {
              description:
                "1 Es mayor de edad, conforme a la Ley peruana vigente. Si es menor de edad, por favor abstenerse de utilizar la herramienta.",
            },
            {
            ...
            {
              description:
                "3 Se encuentra en pleno uso de sus facultades mentales y no adolece de vicio que afecte sus razonamiento, entendimiento y manifestación de voluntad. Por lo tanto, tiene plena capacidad civil, de acuerdo con la Ley peruana vigente.",
            },
            {
              description:
                "4 Ha leído íntegramente los Términos y Condiciones de uso",
            },
            {
              description:
                "5 Actúa y declara únicamente por sí mismo y no en representación de terceros ni de menores de edad conforme a la Ley peruana vigente.",
            },
          ],
        },
        {
