    ...
    const accordion: Accordion[] = [
        {
            ...
            content:['No, los casilleros que ofrecemos son gratis. No cobramos por brindar un espacio para almacenar tus paquetes. Tampoco te vamos a cobrar una renta mensual de mantenimiento.']
        },
        {
            id:'2',
            trigger: 'Cómo debo indicar mi número de casilla y dirección al momento de finalizar la compra de mis productos?',
            content: [
        ...
        {
            id:'4',
            trigger: 'Puedo programar en cualquier momento el envío de mis paquetes a Perú?',
            content: [
        ...
        },
        {
            ...
            content: ['Los documentos que vamos a solicitarte para programar un envío a Perú son los siguientes:'],
            largeContent: [
                {
                    title:'Archivo en PDF del Invoice, recibo o Factura:',
                    content:"Cuando finalizas la compra de tus artículos en determinada tienda, te harán llegar por correo un invoice, recibo o factura donde se detallan los artículos, peso, impuesto o tax y el costo de shipping o envío hacia tu casillero en Miami.",
                },
                {
                    title:'Archivo en PDF de tu documento de',
                    content:'Si el envío lo programaras como persona natural nos haces llegar DNI o CE, si lo haces a través de empresa o persona jurídica debes hacernos llegar el PDF de la ficha RUC que expide SUNAT',
                },
                {
                    title:'Número de WareHouse (WR)',
                    content:'El WR es un código que se genera al momento de registrar la llegada de tus paquetes a tu casillero en nuestras bodegas. Nuestro personal especializado revisa cada paquete que esta identificado con tú numero de Casillero, verifica el número de tracking y lo relaciona con tu WR, enviando esta información a tu cuenta de correo para tu seguimiento.'
                }
            ]
        },
        {
            ...
            content: ['Los productos que a continuación se mencionan son considerados prohibidos por la legislación peruana e internacional, y no se aceptarán para transporte.'],
            largeContent: [
                {
                    title:'Prohibidos por la legislación peruana: ',
                    content:" Armas con o sin licencia, componentes de cualquier tipo de arma, marihuana, cocaína, bienes regulados por el ministerio de cultura, restos arqueológicos, joyas incaicas, entre otros.",
                },
                {
                    title:'Prohibidos por legislación aérea:',
                    content:'Joyas, objetos enchapados en plata, oro, cheques al portador, entre otros.',
                },
                {
    ...
    const cardProps: CardProps[] = [
        {
            icon: Globe,
            title: "Reempaque",
            description:"Prestamos el servicio a solicitud de nuests socios y clientes.",
        },
        {
            icon: CalendarClock,
            title: 'Entregas a Tiempo',
            description: 'Brindamos un delivery seguro y ágil, cumpliendo con nuestros clientes.'
        },
        {
            icon: Truck,
            title: 'Enviamos a todas partes',
            description:'Realizamos envíos con movilidad propia en Lima metropolitana.'
        },
        {
            icon: Plane,
        ...
        <section className="py-10 px-2 lg:px-[100px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 auto-rows-fr gap-5">
                <div className="flex flex-col space-y-3">
                    <h3 className="text-[#003440] text-[36px] font-[700]">Preguntas frecuentes</h3>
                                        ...
                                        <div className="flex flex-col mt-3 space-y-5">
                                            {items.largeContent.map((item, index) => (
                                                <div key={index} className="flex flex-col space-y-3">
                                                    <h3 className="font-bold text-zinc-500">{item.title}</h3>
                                            ...
                                            <p className="text-muted-foreground">
                                                Click en este  
                                                <Link className="font-bold cursor-pointer" 
                                                href='http://www.aduanet.gob.pe/aduanas/infoaduanas/clasifica/clasificacionarancelaria/entidad/anexosRestProhib.htm'> enlace </Link>
                                                 para informacion sobre los anexos del procedimiento de mercancias restringidas y prohibidas INTA-PE.00.06
                                            </p>
                                            )}
                                        </div>
                                    )}
                ...
                <div className="flex flex-col space-y-3">
                    <h3 className="text-[#003440] text-[36px] font-[700]">¿Por qué Elegirnos?</h3>
                            ...
                            <Card key={index} className="shadow-2xl group pt-5">
                                <CardContent className=" flex flex-col space-y-5">
                                    ...
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-[14px]">{items.description}</p>
                                    </div>
                                </CardContent>
                            </Card>
                        ))}
