  ...
  const formFeatures: FormFeatures[] = [
    {
      ...
      description:
        "Recuerda llenar toda la información, si quieres registrarte como persona jurídica, debes ingresar correctamente el RUC y nombre de empresa como aparece en tu ficha RUC.",
    },
    {
      icon: PhoneIcon,
      title: "Número Telefónico",
      description:
        "Bríndanos un número de celular válido, donde podamos mantenerte informado sobre tu número de casillero, seguimiento de tus consultas, envíos, promociones, entre otros.",
    },
    {
      icon: MailsIcon,
      title: "Correo Electrónico",
      description:
        "Con este correo realizaremos la confirmación de tu casillero, es importante que configures el correo info@cabocourier.com como una cuenta segura para que las notificaciones no lleguen al SPAM o Correo no deseado. Debes utilizar tu cuenta de correo registrada para realizar tus compras en el extranjero y solicitar los envíos con nuestros agentes de operaciones.",
    },
  ];
  return (
          ...
          {formFeatures.map((items, index) => (
            ...
            >
              ...
              <div className="flex flex-col space-y-[10px]">
                <h3 className="text-[#002a34] text-[20px] font-[700]">
                  {items.title}
                </h3>
      ...
      >
        ...
        <div className="flex-col space-y-5">
          ...
          <RadioGroup
            ...
            onValueChange={(value) => setAccType(value)}
          >
          ...
          {/* company form */}
          <div
            className={`h-0 overflow-hidden animate-all ease-in-out flex-col space-y-3 flex
